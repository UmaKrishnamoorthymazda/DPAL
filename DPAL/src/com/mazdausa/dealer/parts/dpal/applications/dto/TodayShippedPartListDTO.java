...
public class TodayShippedPartListDTO {
	private String id;
	private String date;
	...
	public TodayShippedPartListDTO() {
	}

	public TodayShippedPartListDTO(String id, String date,
			long orderedQuantity, long myInventory, String partNumber,
			String description, long dealerCode, String dealerName,
			String city, String state, long zip, String trackingNumber) {
		this.id = id;
		this.date = date;
